    ...
    return (
        <MainLayout user={user} activeLink={"Tableau de bord"}>
            ...
            <Flex w="100%" flexWrap="wrap" justifyContent={'space-around'} alignItems={'center'} p={5}>
                <MiniStatistics startContent={<Icon as={MdBalance} w={{base : 12 ,md : 20  }} h={{base : 12 ,md : 20  }} borderRadius='50%' p={2} color='blue.500' bgColor='blue.50' />} name="Mon solde" value={bilan[0].revenu} colorValue={true} w="90%"  mainStat ={true}/>
